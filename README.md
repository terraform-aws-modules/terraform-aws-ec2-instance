...
| <a name="input_auto_recovery"></a> [auto\_recovery](#input\_auto\_recovery) | Automatic recovery behavior of the Instance. Can be `default` or `disabled`. | `string` | `null` | no |
