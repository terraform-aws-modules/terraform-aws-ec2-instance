...
[compliance.tf](https://compliance.tf/docs/workarounds/terraform-aws-ec2-instance/?utm_source=github&utm_medium=readme&utm_campaign=known-limitations) serves this module with these rules applied at
...
https://registry.compliance.tf/playground?module=terraform-aws-modules/ec2-instance/aws&rules=lifecycle_ignore_ami_changes - no account needed.
