...
| num\_suffix\_format | Numerical suffix format appended to the volume name and EC2 instance name if `use_num_suffix` is `"true"` or `instance_count` is greater than one. | string | `"-%d"` | no |
