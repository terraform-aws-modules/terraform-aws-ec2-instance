...
| <a name="module_ec2_complete_ebs_volume_resource"></a> [ec2\_complete\_ebs\_volume\_resource](#module\_ec2\_complete\_ebs\_volume\_resource) | ../../ | n/a |
...
| <a name="output_ec2_complete_ebs_volume_arn"></a> [ec2\_complete\_ebs\_volume\_arn](#output\_ec2\_complete\_ebs\_volume\_arn) | A list of volume ARNs |
| <a name="output_ec2_complete_ebs_volume_id"></a> [ec2\_complete\_ebs\_volume\_id](#output\_ec2\_complete\_ebs\_volume\_id) | A list of volume IDs |
| <a name="output_ec2_complete_ebs_volume_resource_arn"></a> [ec2\_complete\_ebs\_volume\_resource\_arn](#output\_ec2\_complete\_ebs\_volume\_resource\_arn) | The ARN of the instance |
| <a name="output_ec2_complete_ebs_volume_resource_capacity_reservation_specification"></a> [ec2\_complete\_ebs\_volume\_resource\_capacity\_reservation\_specification](#output\_ec2\_complete\_ebs\_volume\_resource\_capacity\_reservation\_specification) | Capacity reservation specification of the instance |
| <a name="output_ec2_complete_ebs_volume_resource_ebs_volume_arn"></a> [ec2\_complete\_ebs\_volume\_resource\_ebs\_volume\_arn](#output\_ec2\_complete\_ebs\_volume\_resource\_ebs\_volume\_arn) | A list of volume ARNs |
| <a name="output_ec2_complete_ebs_volume_resource_ebs_volume_id"></a> [ec2\_complete\_ebs\_volume\_resource\_ebs\_volume\_id](#output\_ec2\_complete\_ebs\_volume\_resource\_ebs\_volume\_id) | A list of volume IDs |
| <a name="output_ec2_complete_ebs_volume_resource_ebs_volume_tags_all"></a> [ec2\_complete\_ebs\_volume\_resource\_ebs\_volume\_tags\_all](#output\_ec2\_complete\_ebs\_volume\_resource\_ebs\_volume\_tags\_all) | A map of tags assigned to the resource, including those inherited from the provider |
| <a name="output_ec2_complete_ebs_volume_resource_id"></a> [ec2\_complete\_ebs\_volume\_resource\_id](#output\_ec2\_complete\_ebs\_volume\_resource\_id) | The ID of the instance |
| <a name="output_ec2_complete_ebs_volume_resource_instance_state"></a> [ec2\_complete\_ebs\_volume\_resource\_instance\_state](#output\_ec2\_complete\_ebs\_volume\_resource\_instance\_state) | The state of the instance. One of: `pending`, `running`, `shutting-down`, `terminated`, `stopping`, `stopped` |
| <a name="output_ec2_complete_ebs_volume_resource_primary_network_interface_id"></a> [ec2\_complete\_ebs\_volume\_resource\_primary\_network\_interface\_id](#output\_ec2\_complete\_ebs\_volume\_resource\_primary\_network\_interface\_id) | The ID of the instance's primary network interface |
| <a name="output_ec2_complete_ebs_volume_resource_private_dns"></a> [ec2\_complete\_ebs\_volume\_resource\_private\_dns](#output\_ec2\_complete\_ebs\_volume\_resource\_private\_dns) | The private DNS name assigned to the instance. Can only be used inside the Amazon EC2, and only available if you've enabled DNS hostnames for your VPC |
| <a name="output_ec2_complete_ebs_volume_resource_public_dns"></a> [ec2\_complete\_ebs\_volume\_resource\_public\_dns](#output\_ec2\_complete\_ebs\_volume\_resource\_public\_dns) | The public DNS name assigned to the instance. For EC2-VPC, this is only available if you've enabled DNS hostnames for your VPC |
| <a name="output_ec2_complete_ebs_volume_resource_public_ip"></a> [ec2\_complete\_ebs\_volume\_resource\_public\_ip](#output\_ec2\_complete\_ebs\_volume\_resource\_public\_ip) | The public IP address assigned to the instance, if applicable. NOTE: If you are using an aws\_eip with your instance, you should refer to the EIP's address directly and not use `public_ip` as this field will change after the EIP is attached |
| <a name="output_ec2_complete_ebs_volume_resource_tags_all"></a> [ec2\_complete\_ebs\_volume\_resource\_tags\_all](#output\_ec2\_complete\_ebs\_volume\_resource\_tags\_all) | A map of tags assigned to the resource, including those inherited from the provider default\_tags configuration block |
| <a name="output_ec2_complete_ebs_volume_resource_volume_attachment_device_name"></a> [ec2\_complete\_ebs\_volume\_resource\_volume\_attachment\_device\_name](#output\_ec2\_complete\_ebs\_volume\_resource\_volume\_attachment\_device\_name) | A list of device names exposed to the instance |
| <a name="output_ec2_complete_ebs_volume_resource_volume_attachment_instance_id"></a> [ec2\_complete\_ebs\_volume\_resource\_volume\_attachment\_instance\_id](#output\_ec2\_complete\_ebs\_volume\_resource\_volume\_attachment\_instance\_id) | A list of IDs of the instances corresponding to volume attachments |
| <a name="output_ec2_complete_ebs_volume_resource_volume_attachment_volume_id"></a> [ec2\_complete\_ebs\_volume\_resource\_volume\_attachment\_volume\_id](#output\_ec2\_complete\_ebs\_volume\_resource\_volume\_attachment\_volume\_id) | A list of IDs of the volumes corresponding to volume attachments |
| <a name="output_ec2_complete_ebs_volume_tags_all"></a> [ec2\_complete\_ebs\_volume\_tags\_all](#output\_ec2\_complete\_ebs\_volume\_tags\_all) | A map of tags assigned to the resource, including those inherited from the provider |
...
| <a name="output_ec2_complete_volume_attachment_device_name"></a> [ec2\_complete\_volume\_attachment\_device\_name](#output\_ec2\_complete\_volume\_attachment\_device\_name) | A list of device names exposed to the instance |
| <a name="output_ec2_complete_volume_attachment_instance_id"></a> [ec2\_complete\_volume\_attachment\_instance\_id](#output\_ec2\_complete\_volume\_attachment\_instance\_id) | A list of IDs of the instances corresponding to volume attachments |
| <a name="output_ec2_complete_volume_attachment_volume_id"></a> [ec2\_complete\_volume\_attachment\_volume\_id](#output\_ec2\_complete\_volume\_attachment\_volume\_id) | A list of IDs of the volumes corresponding to volume attachments |
