...
| <a name="module_ec2_t4g_standard"></a> [ec2\_t4g\_standard](#module\_ec2\_t4g\_standard) | ../../ | n/a |
...
| [aws_ami.amazon_linux2_arm64](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ami) | data source |
...
| <a name="output_ec2_t4g_standard_arn"></a> [ec2\_t4g\_standard\_arn](#output\_ec2\_t4g\_standard\_arn) | The ARN of the instance |
| <a name="output_ec2_t4g_standard_capacity_reservation_specification"></a> [ec2\_t4g\_standard\_capacity\_reservation\_specification](#output\_ec2\_t4g\_standard\_capacity\_reservation\_specification) | Capacity reservation specification of the instance |
| <a name="output_ec2_t4g_standard_id"></a> [ec2\_t4g\_standard\_id](#output\_ec2\_t4g\_standard\_id) | The ID of the instance |
| <a name="output_ec2_t4g_standard_instance_state"></a> [ec2\_t4g\_standard\_instance\_state](#output\_ec2\_t4g\_standard\_instance\_state) | The state of the instance. One of: `pending`, `running`, `shutting-down`, `terminated`, `stopping`, `stopped` |
| <a name="output_ec2_t4g_standard_primary_network_interface_id"></a> [ec2\_t4g\_standard\_primary\_network\_interface\_id](#output\_ec2\_t4g\_standard\_primary\_network\_interface\_id) | The ID of the instance's primary network interface |
| <a name="output_ec2_t4g_standard_private_dns"></a> [ec2\_t4g\_standard\_private\_dns](#output\_ec2\_t4g\_standard\_private\_dns) | The private DNS name assigned to the instance. Can only be used inside the Amazon EC2, and only available if you've enabled DNS hostnames for your VPC |
| <a name="output_ec2_t4g_standard_public_dns"></a> [ec2\_t4g\_standard\_public\_dns](#output\_ec2\_t4g\_standard\_public\_dns) | The public DNS name assigned to the instance. For EC2-VPC, this is only available if you've enabled DNS hostnames for your VPC |
| <a name="output_ec2_t4g_standard_public_ip"></a> [ec2\_t4g\_standard\_public\_ip](#output\_ec2\_t4g\_standard\_public\_ip) | The public IP address assigned to the instance, if applicable. NOTE: If you are using an aws\_eip with your instance, you should refer to the EIP's address directly and not use `public_ip` as this field will change after the EIP is attached |
| <a name="output_ec2_t4g_standard_tags_all"></a> [ec2\_t4g\_standard\_tags\_all](#output\_ec2\_t4g\_standard\_tags\_all) | A map of tags assigned to the resource, including those inherited from the provider default\_tags configuration block |
